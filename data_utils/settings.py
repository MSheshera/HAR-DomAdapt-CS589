...
groups = [['2','9','10','15'], ['13','10','9','8'], ['10','2','3','9'], 
	['11','8','15','5']]
tl_groups_diff = [
	{'source':['2','9','10'],'target':['15']}, # Bad
	{'source':['13','10','9'],'target':['8']}, # Bad
	{'source':['8','15','11'],'target':['2']}, # Bad
	{'source':['5','11','8'],'target':['2']} # Bad
	]
tl_groups_similar = [
	{'source':['10','2','3'],'target':['9']}, # Good
	{'source':['11','8','15'],'target':['5']},  # Good
	{'source':['13','1','10'],'target':['3']}, # Good
	{'source':['13','10','3'],'target':['12']} # tl_groups_good
	]
